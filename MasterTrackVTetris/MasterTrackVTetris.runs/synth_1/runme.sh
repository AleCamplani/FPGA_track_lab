...
HD_PWD='C:/Users/rasmu/Documents/ExperimentalPhysics/FPGA_track_lab/MasterTrackVTetris/MasterTrackVTetris.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MasterTrack.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MasterTrack.tcl
