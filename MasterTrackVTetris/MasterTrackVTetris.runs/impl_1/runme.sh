...
HD_PWD='C:/Users/rasmu/Documents/ExperimentalPhysics/FPGA_track_lab/MasterTrackVTetris/MasterTrackVTetris.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MasterTrack.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MasterTrack.tcl -notrace
